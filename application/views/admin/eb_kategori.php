<title>BLUG | Kategori Ebook</title>
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('admin/A_artikel/artikel'); ?>">Ebook</a></li>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4>Tambah Kategori E-book</h4>        
      </div>
      <?php echo form_open('admin/a_ebook/proses_eb_kategori'); ?>
...
<div id="edit_kategori<?= $row->id_kategori; ?>" role="dialog" class="modal fade" >
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4>Edit Kategori E-book</h4>        
      </div>
      <?php echo form_open('admin/a_ebook/proses_eb_kategori', '',  array('acuan' => $row->id_kategori )); ?>
      <div class="modal-body">
          <div class="form-group">
            <label class="col-label-form">Kategori</label>
 ...
 <div class="modal fade" id="hapus_kategori<?= $row->id_kategori; ?>" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <?php echo form_open('admin/a_ebookk/proses_eb_kategori', '', array('acuan' => $row->id_kategori )); ?>
        <div class="modal-body">
