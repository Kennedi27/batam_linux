<title>BLUG : Kategori tutorial</title>
<div class="box">
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('admin/A_tutorial/tutorial'); ?>">tutorial</a></li>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4>Tambah Kategori tutorial</h4>        
      </div>
      <?php echo form_open('admin/A_tutorial/proses_kategori'); ?>
      <div class="modal-body">
          <div class="form-group">
            <label class="col-label-form">Kategori</label>
            <input class="form-control" type="text" name="jenis_kategori" placeholder="Kategori tutorial">
          </div>
      </div>
...
<div id="edit_kategori<?= $row->id_kategori; ?>" role="dialog" class="modal fade" >
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4>Edit Kategori tutorial</h4>        
      </div>
      <?php echo form_open('admin/A_tutorial/proses_kategori', '',  array('acuan' => $row->id_kategori )); ?>
      <div class="modal-body">
          <div class="form-group">
            <label class="col-label-form">Kategori</label>
