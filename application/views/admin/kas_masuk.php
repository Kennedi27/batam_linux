      ...
      <?php } ?>
        ...
        <div class="box-body">
          <table id="example1" class="table table-striped" style="font-size:13px;">
            ...
            <tbody>
              <?php $no = 1; ?>
              <?php foreach ($tampil as $kas_masuk => $row) { ?>
            <tr>
              <td><?= $no++; ?></td>
              <td><?= $row->tanggal; ?></td>
              <td><?= $row->nama; ?></td>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="form-horizontal">
         <?php echo form_open('admin/a_keuangan/proses_pemasukan'); ?>
        <div class="modal-body">
          <div class="form-group">
            <label class="col-sm-4 control-label">Jumlah Setoran</label>
            <div class="col-sm-7">
              <input type="number" name="jumlah" class="form-control" placeholder="Setoran">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7">
              <input type="text" name="keterangan" placeholder="Cth : Uang Iuran" class="form-control">
            </div>
          </div>
...
<div class="modal fade" id="edit<?php echo $row->id_keuangan; ?>" role="dialog">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="form-horizontal">
         <?php echo form_open('admin/a_keuangan/proses_pemasukan','',array('acuan' => $row->id_keuangan)); ?>
        <div class="modal-body">
          <div class="form-group">
            <label class="col-sm-4 control-label">Jumlah Setoran</label>
            <div class="col-sm-7">
