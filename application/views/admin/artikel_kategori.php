<title>BLUG : Kategori Artikel</title>
<div class="box">
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('admin/A_artikel/artikel'); ?>">Artikel</a></li>
...
<div id="tambah_kategori" role="dialog" class="modal fade" >
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <?php echo form_open('admin/A_artikel/proses_kategori'); ?>
      <div class="modal-body">
          <div class="form-group">
            <label class="col-label-form">Kategori</label>
            <input class="form-control" type="text" name="jenis_kategori" placeholder="Kategori Artikel">
          </div>
      </div>
...
<div id="edit_kategori<?= $row->id_kategori; ?>" role="dialog" class="modal fade" >
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <?php echo form_open('admin/A_artikel/proses_kategori', '',  array('acuan' => $row->id_kategori )); ?>
      <div class="modal-body">
          <div class="form-group">
            <label class="col-label-form">Kategori</label>
