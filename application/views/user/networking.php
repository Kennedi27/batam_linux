	...
	<div id="container-body">
		<div class="nav-menu">
			...
			<div class="active_division">
				<div class="photo_div">
					<img src="<?= base_url('template/images/Logo_divisi/networking.png'); ?>" alt="Divisi Networking">
				</div>
		...
		<div id="box-content">
			<div class="side-left">
				<div class="logo1">
					<img src="<?= base_url('template/images/Logo_divisi/networking.png'); ?>">
