	<div class="row">
		<div class="col-md-3">
			 <div class="scroll" style="padding-top: 25px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
		...
		<div class="col-md-3" style="margin-top: 10px; margin-bottom: 10px; ">
			<div style="margin-left :6px; padding-left:  10px; padding-right: 10px; margin-right: 10px; background-color: white; padding-bottom: 20px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
